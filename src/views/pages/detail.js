...
import LikeButtonPresent from '../../scripts/utils/like-Initiator';
  ...
  async afterRender() {
    ...
    const item = () => (
      `<div class="spesifikData">
          <div class = 'details'>
            <div>
              <img class="imgDetail lazyload" alt="${spesifikRestaurant.name}" width = "auto" src="${Config.baseImgURL}large/${spesifikRestaurant.pictureId}" data-src="${Config.baseImgURL}large/${spesifikRestaurant.pictureId}"></img>
            </div>
